...
import org.cocreate.CoCreate.model.entity.Workflow;
...
public class ProjectController {
    ...
    @PostMapping("/{projectId}/update-workflow")
    public ResponseEntity<ResponseMessage> updateWorkflow(@PathVariable String userId, @PathVariable String projectId, @RequestBody Workflow workflowDTO){
        return ResponseEntity.ok(projectService.updateWorkflow(userId, projectId, workflowDTO));
    }
